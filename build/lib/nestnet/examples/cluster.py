...
They are destroyed when the links are deleted in nestnet.stop()
...
from nestnet.node import Node, Host, OVSSwitch, Controller
from nestnet.link import Link, Intf
from nestnet.net import Mininet
from nestnet.topo import LinearTopo
from nestnet.topolib import TreeTopo
from nestnet.util import quietRun, errRun, decode
from nestnet.examples.clustercli import CLI
from nestnet.log import setLogLevel, debug, info, error
from nestnet.clean import addCleanupCallback
...
class MininetCluster( Mininet ):
    ...
    def __init__( self, *args, **kwargs ):
        ...
        nestnet.__init__( self, *args, **params )
    ...
    def modifiedaddHost( self, *args, **kwargs ):
        ...
        return nestnet.addHost( *args, **kwargs )
    ...
    def addController( self, *args, **kwargs ):
        ...
        controller = nestnet.addController( self, *args, **kwargs )
    ...
    def buildFromTopo( self, *args, **kwargs ):
        ...
        self.placeNodes()
        info( '\n' )
        nestnet.buildFromTopo( self, *args, **kwargs )
