...
from nestnet.log import info, debug, warn, setLogLevel
from nestnet.net import Mininet, VERSION
from nestnet.util import (netParse, ipAdd, quietRun,
                          buildTopo, custom, customClass )
from nestnet.term import makeTerm, cleanUpScreens
from nestnet.node import (Controller, RemoteController, NOX, OVSController,
                          CPULimitedHost, Host, Node,
                          OVSSwitch, UserSwitch, IVSSwitch )
from nestnet.link import TCLink, Intf, Link
from nestnet.cli import CLI
from nestnet.moduledeps import moduleDeps
from nestnet.topo import SingleSwitchTopo, LinearTopo, SingleSwitchReversedTopo
...
class MiniEdit( Frame ):
    ...
    "A simple network editor for nestnet."
    ...
    def exportScript( self ):
        ...
        if len(fileName ) > 0:
            ...
            f.write("\n")
            f.write("from nestnet.net import Mininet\n")
            f.write("from nestnet.node import Controller, RemoteController, OVSController\n")
            f.write("from nestnet.node import CPULimitedHost, Host, Node\n")
            f.write("from nestnet.node import OVSKernelSwitch, UserSwitch\n")
            if StrictVersion(MININET_VERSION) > StrictVersion('2.0'):
                f.write("from nestnet.node import IVSSwitch\n")
            f.write("from nestnet.cli import CLI\n")
            f.write("from nestnet.log import setLogLevel, info\n")
            f.write("from nestnet.link import TCLink, Intf\n")
