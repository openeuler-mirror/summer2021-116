...
Currently we wrap the entire network in a 'nestnet' object, which
...
and bandwidth tests and running the nestnet CLI.
...
from nestnet.node import (Node, Isula, Host, OVSKernelSwitch, DefaultController,
...
class Mininet( object ):
    ...
    def buildFromTopo( self, topo=None ):
        """Build nestnet from a topology object
...
class Nestnet( Mininet ):
    ...
    def addSAPNAT(self, SAPSwitch):
        ...
        # due to a bug with python-iptables, removing and finding rules does not succeed when the nestnet CLI is running
