...
from nestnet.node import OVSSwitch, UserSwitch, IVSSwitch
from nestnet.node import CPULimitedHost
from nestnet.link import TCLink
...
class testOptionsTopoCommon( object ):
    ...
    def runOptionsTopoTest( self, n, msg, hopts=None, lopts=None ):
        ...
        msg += ( '%s%% of pings were dropped during nestnet.ping().\n'
    ...
    def testLinkLoss( self ):
        ...
        msg = ( '\nTesting packet loss with %d%% loss rate\n'
                'number of dropped pings during nestnet.ping(): %s\n'
